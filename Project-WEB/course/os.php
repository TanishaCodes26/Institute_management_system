        ...
        <section class="sec-1">
            <div class="course-container">
                ...
                <div class="left-section">
                    ...
                    <h1 class="course-heading">Mastering Operating Systems: The Backbone of Computing</h1>
                    <h2 class="course-tagline">" Master the concepts behind modern operating systems. "</h2>
                    ...
                    <div class="course-content">
                        <div class="column">
                            <p>➡️Process Management: Scheduling and Synchronization</p>
                            <p>➡️Memory Management: Paging, Segmentation, and Virtual Memory</p>
                        </div>
                        <div class="column">
                            <p>➡️File Systems and Storage Management</p>
                            <p>➡️Input/Output (I/O) Systems and Device Management</p>
                        </div>
                ...
                <div class="right-section">
                    <img src="../img/os-back.png" alt="Course Image" class="laptop">
                </div>
            </div>
        </section>
            ...
            <div class="section-container-sec3">
                ...
                <div class="right-part-sec3">
                    ...
                    <ul class="right-part-list">
                        <li>🔵Understand the fundamental operations of modern operating systems.</li>
                        <li>🔵Gain insights into process scheduling, memory allocation, and file management.</li>
                        <li>🔵Learn to work with multithreading, synchronization, and concurrency.</li>
                        <li>🔵Hands-on experience with OS-related projects.</li>
                    </ul>
        ...
        <section class="sec-4">
            <div class="section-container-sec4">
                ...
                <div class="right-part-sec4">
                    ...
                    <div class="faq-item">
                        <h4>What makes this course different from other OS courses?</h4>
                        <p>This course not only covers theoretical concepts but also focuses on practical implementation with hands-on projects to solidify your learning.
                        </p>
                    </div>

                    <div class="faq-item">
                        <h4>Do I need programming experience to enroll in this course?</h4>
                        <p>Basic programming knowledge is recommended, especially in C or Java, but the course will guide you through the necessary programming skills needed for OS development.</p>
                    </div>

                    <div class="faq-item">
                        <h4>Can I learn about distributed operating systems in this course?</h4>
                        <p>Yes, we cover distributed OS concepts in the later weeks, including cloud-based operating systems and their architectures.
                        </p>
                    </div>
                </div>
            </div>
