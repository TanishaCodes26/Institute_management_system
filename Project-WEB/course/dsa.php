        ...
        <section class="sec-1">
            <div class="course-container">
                ...
                <div class="left-section">
                    ...
                    <h1 class="course-heading">Data Structure and Algorithm</h1>
                    <h2 class="course-tagline">" Learn how to structure and optimize data for efficiency. "</h2>
                    ...
                    <div class="course-content">
                        <div class="column">
                            <p>➡️Introduction to DSA and Problem-Solving Techniques</p>
                            <p>➡️ Arrays, Linked Lists, and Strings</p>
                        </div>
                        <div class="column">
                            <p>➡️Stacks, Queues, and Recursion</p>
                            <p>➡️Trees and Binary Search Trees (BST)</p>
                        </div>
                ...
                <div class="right-section">
                    <img src="../img/dsa-back.png" alt="Course Image" class="laptop">
                </div>
            </div>
        </section>
            ...
            <div class="section-container-sec3">
                ...
                <div class="right-part-sec3">
                    ...
                    <ul class="right-part-list">
                        <li>🔵Develop a strong foundation in essential data structures.</li>
                        <li>🔵Learn algorithmic problem-solving techniques like dynamic programming and backtracking.</li>
                        <li>🔵Build efficiency and optimization skills crucial for technical interviews and competitive coding.</li>
                        <li>🔵Solve real-world problems using advanced DSA concepts.</li>
                    </ul>
            ...
            <div class="section-container-sec4">
                ...
                <div class="left-part-sec4">
                    ...
                    <div class="teacher-circle">
                        <a href=""><img src="../img/anirban-dsa.png" alt="Teacher Image"></a>
                    </div>

                    <!-- Box 1: Teacher Heading and Text -->
                    <div class="info">
                        <p>Name: Dr. Arindam Mukherjee</p>
                        <p>Phone: +91 9876543210</p>
                        <p>Email: arindam.mukherjee@csedu.in</p>
                        <hr>
                    </div>
                    ...
                    <div class="info-box">
                        ...
                        <p>Dr. Mukherjee is highly approachable and offers regular one-on-one mentorship sessions for
                            students struggling with programming concepts or looking to excel in competitive coding. He
                            hosts weekly coding challenges and problem-solving sessions to help students apply
                            theoretical knowledge in a practical setting. He also provides feedback on projects and
                            coding assignments, helping students improve their programming and algorithmic skills.</p>
                    </div>
                </div>
                ...
                <div class="right-part-sec4">
                    ...
                    <div class="faq-item">
                        ...
                        <p>Yes, basic knowledge of any programming language is required. The course will focus on DSA concepts, so familiarity with syntax and coding is important.
                        </p>
                    </div>

                    <div class="faq-item">
                        <h4>What type of projects will we work on?</h4>
                        <p>You will work on several real-world projects like building a task scheduler, pathfinding algorithms, and solving complex coding challenges using dynamic programming, graphs, and trees.

                        </p>
                    </div>

                    <div class="faq-item">
                        <h4>Will this course prepare me for coding interviews?</h4>
                        <p>Absolutely! This course is designed to strengthen your problem-solving skills and provide you with the necessary knowledge and practice for acing technical interviews.
                        </p>
                    </div>
                </div>
            </div>
