        ...
        <section class="sec-1">
            <div class="course-container">
                ...
                <div class="left-section">
                    ...
                    <h1 class="course-heading">C++ Programming Language</h1>
                    <h2 class="course-tagline">" Master object-oriented programming with C++. "</h2>
                    ...
                    <div class="course-content">
                        <div class="column">
                            <p>➡️Introduction to C++, Basic Syntax</p>
                            <p>➡️Control Structures</p>
                        </div>
                        <div class="column">
                            <p>➡️Arrays, Pointers, and Dynamic Memory Allocation</p>
                ...
                <div class="right-section">
                    <img src="../img/c++-back.png" alt="Course Image" class="laptop">
                </div>
            </div>
        </section>
            ...
            <div class="section-container-sec3">
                ...
                <div class="right-part-sec3">
                    ...
                    <ul class="right-part-list">
                        <li>🔵Master the fundamentals of C++ and OOP concepts.</li>
                        <li>🔵Efficiently use pointers and dynamic memory in your programs.</li>
                        <li>🔵Build complex applications using C++ features like templates and STL.</li>
                        <li>🔵Gain experience in solving real-world programming problems.</li>
                    </ul>
        ...
        <section class="sec-4">
            <div class="section-container-sec4">
                ...
                <div class="right-part-sec4">
                    ...
                    <div class="faq-item">
                        <h4>What prior knowledge do I need for this course?</h4>
                        <p>Basic knowledge of any programming language is helpful, but not mandatory. We start from the very basics of C++.
                        </p>
                    </div>

                    <div class="faq-item">
                        <h4>What kind of projects will I work on during the course?</h4>
                        <p>You will work on real-world projects like a student management system, a basic library management tool, and even a console-based game to enhance your practical skills.</p>
                    </div>

                    <div class="faq-item">
                        <h4>Will I get a certificate after completing the course?</h4>
                        <p>Yes, you will receive a certificate of completion once you finish the course and the final project successfully.
                        </p>
                    </div>
                </div>
            </div>
