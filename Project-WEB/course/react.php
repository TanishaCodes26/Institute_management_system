        ...
        <section class="sec-1">
            <div class="course-container">
                ...
                <div class="left-section">
                    ...
                    <h1 class="course-heading">Mastering React: Build Dynamic User Interfaces</h1>
                    <h2 class="course-tagline">" Build modern web applications with React. "</h2>
                    ...
                    <div class="course-content">
                        <div class="column">
                            <p>➡️Introduction to React: JSX, Components, and Props</p>
                            <p>➡️State Management and React Hooks</p>
                        </div>
                        <div class="column">
                            <p>➡️Event Handling and Conditional Rendering</p>
                            <p>➡️React Router: Navigation and Multi-Page Apps</p>
                        </div>
                ...
                <div class="right-section">
                    <img src="../img/react-back.png" alt="Course Image" class="laptop">
                </div>
            </div>
        </section>
            ...
            <div class="section-container-sec3">
                ...
                <div class="right-part-sec3">
                    ...
                    <ul class="right-part-list">
                        <li>🔵Learn how to build responsive, dynamic, and interactive user interfaces.</li>
                        <li>🔵Master state management, React hooks, and component-based architecture.</li>
                        <li>🔵Integrate React with APIs for fetching and managing data.</li>
                        <li>🔵Build a fully functional web application using React from scratch.</li>
                    </ul>
            ...
            <div class="section-container-sec4">
                ...
                <div class="left-part-sec4">
                    ...
                    <div class="teacher-circle">
                        <a href=""><img src="../img/bikram-back.png" alt="Teacher Image"></a>
                    </div>

                    <!-- Box 1: Teacher Heading and Text -->
                    <div class="info">
                        <p>Name: Mr. Vikram Patel</p>
                        <p>Phone: +91 9876543210</p>
                        <p>Email: vikram.patel@backendedu.com</p>
                        <hr>
                    </div>
                    ...
                    <div class="info-box">
                        ...
                        <p>Mr. Patel is committed to maintaining an interactive learning environment. He offers
                            personalized guidance through one-on-one mentoring sessions and group projects. He
                            encourages students to participate in hackathons and coding competitions, providing them
                            with opportunities to showcase their skills. Regular guest lectures from industry experts
                            further enhance the learning experience.</p>
                    </div>
                </div>
                ...
                <div class="right-part-sec4">
                    ...
                    <div class="faq-item">
                        <h4>Do I need prior React experience to join this course?</h4>
                        <p>No prior React experience is required, but a solid foundation in HTML, CSS, and JavaScript is necessary.
                        </p>
                    </div>

                    <div class="faq-item">
                        <h4>What kind of projects will I work on during this course?</h4>
                        <p>You'll build a real-world web application using React, which includes dynamic content, multiple pages, and API integration.</p>
                    </div>

                    <div class="faq-item">
                        <h4>Will I receive a certificate after completing the course?</h4>
                        <p>Yes, you'll receive a certificate of completion after finishing the course and successfully submitting your project.
                        </p>
                    </div>
                </div>
            </div>
