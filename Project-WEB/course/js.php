        ...
        <section class="sec-1">
            <div class="course-container">
                ...
                <div class="left-section">
                    ...
                    <h1 class="course-heading">Mastering Java script</h1>
                    <h2 class="course-tagline">" Enhance website interactivity with JavaScript. "</h2>
                    ...
                    <div class="course-content">
                        <div class="column">
                            <p>➡️Introduction to JavaScript, Syntax, and Variables</p>
                            <p>➡️Data Types, Operators, and Control Structures</p>
                        </div>
                        <div class="column">
                            <p>➡️Functions, Scope, and Hoisting</p>
                            <p>➡️DOM Manipulation: Accessing and Changing Web Pages</p>
                        </div>
                ...
                <div class="right-section">
                    <img src="../img/js-back.png" alt="Course Image" class="laptop">
                </div>
            </div>
        </section>
            ...
            <div class="section-container-sec3">
                ...
                <div class="right-part-sec3">
                    ...
                    <ul class="right-part-list">
                        <li>🔵Understand core JavaScript concepts like variables, functions, and data types.</li>
                        <li>🔵Learn how to manipulate the DOM and create interactive websites.</li>
                        <li>🔵Master event handling, form validation, and asynchronous programming.</li>
                        <li>🔵Build a dynamic, interactive web application using JavaScript.</li>
                    </ul>
        ...
        <section class="sec-4">
            <div class="section-container-sec4">
                ...
                <div class="right-part-sec4">
                    ...
                    <div class="faq-item">
                        <h4>Do I need any prior JavaScript experience for this course?</h4>
                        <p>No prior JavaScript experience is needed, but basic knowledge of HTML and CSS is recommended.
                        </p>
                    </div>

                    <div class="faq-item">
                        <h4>What kind of projects will I work on in this course?</h4>
                        <p>You'll build multiple mini-projects and a final dynamic web application using JavaScript, incorporating DOM manipulation, event handling, and APIs.</p>
                    </div>

                    <div class="faq-item">
                        <h4>Will I receive a certificate after completing the course?</h4>
                        <p>Yes, you will receive a certificate of completion once you finish the course and submit the final project.
                        </p>
                    </div>
                </div>
            </div>
