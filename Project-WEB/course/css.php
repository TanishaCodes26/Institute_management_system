        ...
        <section class="sec-1">
            <div class="course-container">
                ...
                <div class="left-section">
                    ...
                    <h1 class="course-heading">Mastering CSS</h1>
                    <h2 class="course-tagline">" Design beautiful websites with powerful CSS styling. "</h2>
                    ...
                    <div class="course-content">
                        <div class="column">
                            <p>➡️Introduction to CSS, Selectors, and Syntax</p>
                            <p>➡️CSS Box Model: Margins, Padding, Borders, and Layouts</p>
                        </div>
                        <div class="column">
                            <p>➡️Working with Colors, Backgrounds, and Fonts</p>
                            <p>➡️Flexbox and Grid Layout Systems</p>
                        </div>
            ...
            <div class="section-container-sec3">
                ...
                <div class="right-part-sec3">
                    ...
                    <ul class="right-part-list">
                        <li>🔵Master CSS to style web pages with precision and creativity.</li>
                        <li>🔵Learn modern layout techniques like Flexbox and Grid.</li>
                        <li>🔵Build fully responsive web designs that work on all devices.</li>
                        <li>🔵Add animations and transitions to enhance user experience.</li>
                    </ul>
        ...
        <section class="sec-4">
            <div class="section-container-sec4">
                ...
                <div class="right-part-sec4">
                    ...
                    <div class="faq-item">
                        <h4>Do I need prior experience with CSS to join this course?</h4>
                        <p>No, prior experience with CSS isn’t required, but basic HTML knowledge is recommended.
                        </p>
                    </div>

                    <div class="faq-item">
                        <h4>What type of project will I complete in this course?</h4>
                        <p>You’ll create a responsive portfolio website using the CSS techniques learned throughout the course, including Flexbox, Grid, and animations.</p>
                    </div>

                    <div class="faq-item">
                        <h4>Will I receive a certificate after completing the course?</h4>
                        <p>Yes, a certificate of completion will be provided after you finish the course and submit the final project.
                        </p>
                    </div>
                </div>
            </div>
