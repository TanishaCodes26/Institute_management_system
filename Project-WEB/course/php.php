        ...
        <section class="sec-1">
            <div class="course-container">
                ...
                <div class="left-section">
                    ...
                    <h1 class="course-heading">Mastering PHP: Build Dynamic Websites</h1>
                    <h2 class="course-tagline">" Develop dynamic websites using PHP server-side scripting. "</h2>
                    ...
                    <div class="course-content">
                        <div class="column">
                            <p>➡️Introduction to PHP: Syntax</p>
                            <p>➡️Forms, Data Handling, and Super Globals</p>
                        </div>
                        <div class="column">
                            <p>➡️Working with Databases: MySQL Integration</p>
                            <p>➡️Sessions, Cookies, and Authentication</p>
                        </div>
                ...
                <div class="right-section">
                    <img src="../img/php-back.png" alt="Course Image" class="laptop">
                </div>
            </div>
        </section>
            ...
            <div class="section-container-sec3">
                ...
                <div class="right-part-sec3">
                    ...
                    <ul class="right-part-list">
                        <li>🔵Understand the core concepts of server-side scripting with PHP.</li>
                        <li>🔵Learn how to integrate PHP with MySQL for dynamic data-driven websites.</li>
                        <li>🔵Implement user authentication, form validation, and session handling.</li>
                        <li>🔵Build a complete web application using PHP.</li>
                    </ul>
        ...
        <section class="sec-4">
            <div class="section-container-sec4">
                ...
                <div class="right-part-sec4">
                    ...
                    <div class="faq-item">
                        <h4>Do I need prior PHP experience to take this course?</h4>
                        <p>No prior experience with PHP is needed, but familiarity with HTML and CSS will be helpful.
                        </p>
                    </div>

                    <div class="faq-item">
                        <h4>What kind of project will I work on?</h4>
                        <p>You’ll build a dynamic website that incorporates user authentication, data management, and interaction with databases.</p>
                    </div>

                    <div class="faq-item">
                        <h4>Will I receive a certificate upon completion?</h4>
                        <p>Yes, after completing the course and final project, you'll receive a certificate of completion.
                        </p>
                    </div>
                </div>
            </div>
