        ...
        <section class="sec-1">
            <div class="course-container">
                ...
                <div class="left-section">
                    ...
                    <h1 class="course-heading">Python Programming</h1>
                    <h2 class="course-tagline">" Dive into Python for versatile programming and automation. "</h2>
                    ...
                    <div class="course-content">
                        <div class="column">
                            <p>➡️Introduction to Python and Basic Syntax</p>
                            <p>➡️Variables, Data Types, and Operators</p>
                        </div>
                        <div class="column">
                            <p>➡️Data Structures: Lists, Tuples, Dictionaries, and Sets</p>
                            <p>➡️Object-Oriented Programming in python</p>
                        </div>
                ...
                <div class="right-section">
                    <img src="../img/py-back.png" alt="Course Image" class="laptop">
                </div>
            </div>
        </section>
            ...
            <div class="section-container-sec3">
                ...
                <div class="right-part-sec3">
                    ...
                    <ul class="right-part-list">
                        <li>🔵Learn Python from scratch and develop a solid programming foundation.</li>
                        <li>🔵Master data structures and algorithms using Python.</li>
                        <li>🔵Build practical applications for real-world tasks, like automation and web scraping.</li>
                        <li>🔵Get introduced to Python's role in data science and AI development.</li>
                    </ul>
        ...
        <section class="sec-4">
            <div class="section-container-sec4">
                ...
                <div class="right-part-sec4">
                    ...
                    <div class="faq-item">
                        <h4>Do I need any prior experience to take this course?</h4>
                        <p>No prior experience is required. This course is designed for complete beginners, but experienced programmers can also benefit from the advanced modules.
                        </p>
                    </div>

                    <div class="faq-item">
                        <h4>What projects will I build during the course?</h4>
                        <p>You will work on several projects, including automation scripts, web scraping tools, and a basic data analysis project using Python.</p>
                    </div>

                    <div class="faq-item">
                        <h4>Will I receive a certificate after completing the course?</h4>
                        <p>Yes, you will get a certificate of completion after successfully finishing the course and submitting the final project.
                        </p>
                    </div>
                </div>
            </div>
