        ...
        <section class="sec-1">
            <div class="course-container">
                ...
                <div class="left-section">
                    ...
                    <h1 class="course-heading">Java Programming Language</h1>
                    <h2 class="course-tagline">" Explore the world of Java for modern development. "</h2>
                    ...
                    <div class="course-content">
                        <div class="column">
                            <p>➡️Introduction to Java, Basics of Java Syntax</p>
                            <p>➡️Variables, Data Types, Operators, and Expressions</p>
                        </div>
                        <div class="column">
                            <p>➡️Control Structures</p>
                            <p>➡️Object-Oriented Programming</p>
                        </div>
                ...
                <div class="right-section">
                    <img src="../img/java-back.png" alt="Course Image" class="laptop">
                </div>
            </div>
        </section>
            ...
            <div class="section-container-sec3">
                ...
                <div class="right-part-sec3">
                    ...
                    <ul class="right-part-list">
                        <li>🔵Build a strong foundation in Java programming from scratch.</li>
                        <li>🔵Understand and implement OOP concepts in real-world projects.</li>
                        <li>🔵Master file handling, multithreading, and Java collections.</li>
                        <li>🔵Develop GUI-based applications and connect Java with databases.</li>
                    </ul>
            ...
            <div class="section-container-sec4">
                ...
                <div class="left-part-sec4">
                    ...
                    <div class="teacher-circle">
                        <a href=""><img src="../img/ramesh-java.png" alt="Teacher Image"></a>
                    </div>

                    <!-- Box 1: Teacher Heading and Text -->
                    <div class="info">
                        <p>Name: Dr. Ramesh Gupta</p>
                        <p>Phone: +91 9876543210</p>
                        <p>Email: ramesh.gupta@softwareedu.in</p>
                        <hr>
                    </div>
                    ...
                    <div class="info-box">
                        ...
                        <p>Dr. Gupta offers extensive interaction opportunities, including weekly coding challenges,
                            project reviews, and live coding sessions. He encourages students to actively participate in
                            open-source Java projects and provides guidance for industry certifications like OCJP. His
                            mentorship sessions are tailored to help students prepare for careers in software
                            development, with a focus on Java-based enterprise solutions.</p>
                    </div>
                </div>
                ...
                <div class="right-part-sec4">
                    ...
                    <div class="faq-item">
                        <h4>Do I need prior programming knowledge to enroll in this Java course?</h4>
                        <p>Prior programming experience is not necessary, but having basic knowledge will help you pick up concepts faster.
                        </p>
                    </div>

                    <div class="faq-item">
                        <h4>What type of projects will I build in this course?</h4>
                        <p>You will build several hands-on projects, including a Student Management System, a Java-based to-do list app, and a final project where you’ll apply advanced concepts like database integration.</p>
                    </div>

                    <div class="faq-item">
                        <h4>Will I receive any certificate after completing the course?</h4>
                        <p>Yes, you will receive a certificate of completion after successfully finishing the course and submitting the final project.
                        </p>
                    </div>
                </div>
            </div>
