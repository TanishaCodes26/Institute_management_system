        ...
        <section class="sec-1">
            <div class="course-container">
                ...
                <div class="left-section">
                    ...
                    <h2 class="course-tagline">" Learn the fundamentals of C programming from scratch. "</h2>
                    ...
                    <div class="course-content">
                        <div class="column">
                            <p>➡️Introduction to C Programming</p>
                            <p>➡️Basic Syntax and Operators</p>
                        </div>
                        <div class="column">
                            <p>➡️Loops and Functions</p>
                            <p>➡️Arrays and Strings</p>
                        </div>
            ...
            <div class="section-container-sec3">
                ...
                <div class="right-part-sec3">
                    ...
                    <ul class="right-part-list">
                        <li>🔵Beginners who want to learn programming.</li>
                        <li>🔵Students who need C programming knowledge for their academic studies.</li>
                        <li>🔵Developers interested in learning low-level programming.</li>
                        <li>🔵Professionals looking to sharpen their skills in C for system-level programming.</li>
                    </ul>
        ...
        <section class="sec-4">
            <div class="section-container-sec4">
                ...
                <div class="right-part-sec4">
                    ...
                    <div class="faq-item">
                        <h4>What is C programming?</h4>
                        <p>C is a general-purpose programming language that is extremely popular, simple, and flexible.
                        </p>
                    </div>

                    <div class="faq-item">
                        <h4>What are the uses of C language?</h4>
                        <p>C language is widely used in system programming, developing operating systems, and creating
                            applications.</p>
                    </div>

                    <div class="faq-item">
                        <h4>How can I learn C efficiently?</h4>
                        <p>Practice consistently, focus on understanding pointers, memory management, and work on
                            projects.
                        </p>
                    </div>
                </div>
