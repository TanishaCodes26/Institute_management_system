        ...
        <section class="sec-1">
            <div class="course-container">
                ...
                <div class="left-section">
                    ...
                    <h1 class="course-heading">HTML for Beginners</h1>
                    <h2 class="course-tagline">" Build the foundation of web development with HTML "</h2>
                    ...
                    <div class="course-content">
                        <div class="column">
                            <p>➡️Introduction to HTML and Setting Up Your Development Environment</p>
                            <p>➡️ Basic HTML Structure: Elements, Tags, and Attributes</p>
                        </div>
                        <div class="column">
                            <p>➡️Formatting Content: Headings, Paragraphs, Links, and Images</p>
                            <p>➡️ Creating Lists, Tables, and Forms in HTML</p>
                        </div>
                ...
                <div class="right-section">
                    <img src="../img/html-back.png" alt="Course Image" class="laptop">
                </div>
            </div>
        </section>
            ...
            <div class="section-container-sec3">
                ...
                <div class="right-part-sec3">
                    ...
                    <ul class="right-part-list">
                        <li>🔵Understand the core structure of HTML and its usage in web development.</li>
                        <li>🔵Learn to create fully functional and responsive web pages.</li>
                        <li>🔵Gain the ability to embed media and create interactive forms.</li>
                        <li>🔵Build and publish your first personal or portfolio website.</li>
                    </ul>
            ...
            <div class="section-container-sec4">
                ...
                <div class="left-part-sec4">
                    ...
                    <div class="teacher-circle">
                        <a href=""><img src="../img/aditi-front.png" alt="Teacher Image"></a>
                    </div>

                    <!-- Box 1: Teacher Heading and Text -->
                    <div class="info">
                        <p>Name: Ms. Aditi Sharma</p>
                        <p>Phone: +91 9876543210</p>
                        <p>Email: aditi.sharma@webedu.com</p>
                        <hr>
                    </div>
                    ...
                    <div class="info-box">
                        ...
                        <p>Ms. Sharma encourages open communication and actively engages with her students through
                            coding challenges and project reviews. She provides personalized feedback and mentorship,
                            guiding students through the latest trends and technologies in front-end development.
                            Regular industry guest lectures and workshops are also organized to enhance students'
                ...
                <div class="right-part-sec4">
                    ...
                    <div class="faq-item">
                        <h4>Do I need any prior coding experience for this HTML course?</h4>
                        <p>No prior coding experience is necessary. This course is designed for absolute beginners.
                        </p>
                    </div>

                    <div class="faq-item">
                        <h4>What projects will I be working on during this course?</h4>
                        <p>By the end of the course, you’ll create a personal portfolio website using all the HTML skills you’ve learned.</p>
                    </div>

                    <div class="faq-item">
                        <h4>Will I receive a certificate after completing the course?</h4>
                        <p>Yes, you will get a certificate of completion after finishing the course and submitting the final project.
                        </p>
                    </div>
                </div>
            </div>
