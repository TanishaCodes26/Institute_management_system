        ...
        <section class="sec-1">
            <div class="course-container">
                ...
                <div class="left-section">
                    ...
                    <h1 class="course-heading">Mastering SQL: The Language of Databases</h1>
                    <h2 class="course-tagline">" Manage databases with MySQL for data storage and retrieval. "</h2>
                    ...
                    <div class="course-content">
                        <div class="column">
                            <p>➡️Introduction to SQL and Relational Databases</p>
                            <p>➡️Basic SQL Queries: SELECT, WHERE, and ORDER BY</p>
                        </div>
                        <div class="column">
                            <p>➡️Data Manipulation: INSERT, UPDATE, DELETE</p>
                            <p>➡️Joins, Aggregation Functions, and Subqueries</p>
                        </div>
                ...
                <div class="right-section">
                    <img src="../img/sql-back.png" alt="Course Image" class="laptop">
                </div>
            </div>
        </section>
            ...
            <div class="section-container-sec3">
                ...
                <div class="right-part-sec3">
                    ...
                    <ul class="right-part-list">
                        <li>🔵Learn SQL syntax and best practices for managing databases.</li>
                        <li>🔵Retrieve, filter, and manipulate data using complex queries.</li>
                        <li>🔵Understand relational database design and optimization.</li>
                        <li>🔵Develop hands-on experience with popular SQL-based database systems.</li>
                    </ul>
        ...
        <section class="sec-4">
            <div class="section-container-sec4">
                ...
                <div class="right-part-sec4">
                    ...
                    <div class="faq-item">
                        <h4>Do I need prior SQL experience to join this course?</h4>
                        <p>No prior experience is necessary. The course starts from the basics and gradually covers advanced topics.
                        </p>
                    </div>

                    <div class="faq-item">
                        <h4>What project will I complete during the course?</h4>
                        <p>You’ll work on creating a relational database, writing complex queries, and generating reports as your final project.</p>
                    </div>

                    <div class="faq-item">
                        <h4>Will I receive a certificate after completing the course?</h4>
                        <p>Yes, after successfully completing the course and final project, you will receive a certificate.
                        </p>
                    </div>
                </div>
            </div>
