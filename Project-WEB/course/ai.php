        ...
        <section class="sec-1">
            <div class="course-container">
                ...
                <div class="left-section">
                    ...
                    <h1 class="course-heading">Artificial Intelligence & Machine Learning</h1>
                    <h2 class="course-tagline">" Dive deep into Artificial Intelligence and Machine Learning. "</h2>
                    ...
                    <div class="course-content">
                        <div class="column">
                            <p>➡️Introduction to AI & ML, Python for AI/ML</p>
                            <p>➡️Decision Trees and Random Forests</p>
                        </div>
                        <div class="column">
                            <p>➡️Neural Networks: Basics to Advanced</p>
                            <p>➡️Deep Learning with TensorFlow & Keras</p>
                        </div>
                ...
                <div class="right-section">
                    <img src="../img/ai-back.png" alt="Course Image" class="laptop">
                </div>
            </div>
        </section>
            ...
            <div class="section-container-sec3">
                ...
                <div class="right-part-sec3">
                    ...
                    <ul class="right-part-list">
                        <li>🔵Learn the key concepts of machine learning algorithms and their practical applications.</li>
                        <li>🔵Gain experience with popular tools such as TensorFlow, Keras, and scikit-learn.</li>
                        <li>🔵Build AI models for image recognition, natural language processing, and predictive analytics.</li>
                        <li>🔵Understand the ethics and implications of AI in society.</li>
                    </ul>
            ...
            <div class="section-container-sec4">
                ...
                <div class="left-part-sec4">
                    ...
                    <div class="teacher-circle">
                        <a href=""><img src="../img/priya-py.png" alt="Teacher Image"></a>
                    </div>

                    <!-- Box 1: Teacher Heading and Text -->
                    <div class="info">
                        <p>Name: Dr. Priya Reddy</p>
                        <p>Phone: +91 9876543210</p>
                        <p>Email: priya.reddy@aiml.edu.in</p>
                        <hr>
                    </div>
                    ...
                    <div class="info-box">
                        ...
                        <p> Dr. Reddy provides personalized mentorship to students, offering office hours and online
                            discussion forums. She encourages students to collaborate on AI/ML projects and regularly
                            conducts coding bootcamps and hackathons. Her classes include regular quizzes, real-world
                            case studies, and capstone projects that give students hands-on experience in AI model
                ...
                <div class="right-part-sec4">
                    ...
                    <div class="faq-item">
                        <h4>Is this course suitable for beginners in AI/ML?</h4>
                        <p>Yes, this course is structured for both beginners and those with some knowledge of AI/ML. We start from the basics and gradually move to advanced concepts with hands-on projects.
                        </p>
                    </div>

                    <div class="faq-item">
                        <h4>What programming languages will be used in the course?</h4>
                        <p>Python will be the primary language used for AI/ML algorithms, with libraries such as TensorFlow, Keras, and scikit-learn.</p>
                    </div>

                    <div class="faq-item">
                        <h4>Will I be able to build my own AI/ML models after this course?</h4>
                        <p>Absolutely! By the end of the course, you’ll have the knowledge and experience to build and deploy AI/ML models for a variety of real-world applications.
                        </p>
                    </div>
                </div>
            </div>
