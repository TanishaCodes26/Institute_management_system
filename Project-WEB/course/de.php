        ...
        <section class="sec-1">
            <div class="course-container">
                ...
                <div class="left-section">
                    ...
                    <h1 class="course-heading">Mastering Digital Electronics: From Logic Gates to Complex Circuits</h1>
                    <h2 class="course-tagline">" Explore the fundamentals of digital electronic systems. "</h2>
                    ...
                    <div class="course-content">
                        <div class="column">
                            <p>➡️Logic Gates: AND, OR, NOT, NAND, NOR, XOR</p>
                            <p>➡️Boolean Algebra and Simplification Techniques</p>
                        </div>
                        <div class="column">
                            <p>➡️Flip-Flops, Registers, and Latches</p>
                            <p>➡️Counters, Timers, and Shift Registers</p>
                        </div>
                ...
                <div class="right-section">
                    <img src="../img/de-back.png" alt="Course Image" class="laptop">
                </div>
            </div>
        </section>
            ...
            <div class="section-container-sec3">
                ...
                <div class="right-part-sec3">
                    ...
                    <ul class="right-part-list">
                        <li>🔵Gain a deep understanding of how digital circuits work.</li>
                        <li>🔵Learn to design and implement combinational and sequential circuits.</li>
                        <li>🔵Understand the role of digital electronics in modern computing and embedded systems.</li>
                        <li>🔵Build hands-on projects to apply theoretical knowledge.</li>
                    </ul>
        ...
        <section class="sec-4">
            <div class="section-container-sec4">
                ...
                <div class="right-part-sec4">
                    ...
                    <div class="faq-item">
                        <h4>Is prior knowledge of electronics necessary for this course?</h4>
                        <p>No, basic knowledge is helpful, but all key concepts will be taught from scratch.
                        </p>
                    </div>

                    <div class="faq-item">
                        <h4>Will I get hands-on experience with digital circuits?</h4>
                        <p>Yes, the course includes several practical projects where you'll design and implement real digital circuits.</p>
                    </div>

                    <div class="faq-item">
                        <h4>How will this course help me in my career?</h4>
                        <p>You’ll gain critical skills needed for roles in hardware design, embedded systems, and digital system engineering.
