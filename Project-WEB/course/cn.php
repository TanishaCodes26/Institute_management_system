        ...
        <section class="sec-1">
            <div class="course-container">
                ...
                <div class="left-section">
                    ...
                    <h1 class="course-heading">Mastering Computer Networking: From Basics to Advanced</h1>
                    <h2 class="course-tagline">" Learn the principles of networking for modern communication. "</h2>
                    ...
                    <div class="course-content">
                        <div class="column">
                            <p>➡️Introduction to Networking: LAN, WAN, and Protocols</p>
                            <p>➡️OSI Model and TCP/IP Protocol Suite</p>
                        </div>
                        <div class="column">
                            <p>➡️IP Addressing, Subnetting, and Routing Basics</p>
                            <p>➡️Network Devices: Routers, Switches, Hubs, and Firewalls</p>
                        </div>
                ...
                <div class="right-section">
                    <img src="../img/cn-back.png" alt="Course Image" class="laptop">
                </div>
            </div>
        </section>
            ...
            <div class="section-container-sec3">
                ...
                <div class="right-part-sec3">
                    ...
                    <ul class="right-part-list">
                        <li>🔵Understand the fundamentals of computer networking, from LAN to WAN.</li>
                        <li>🔵Learn how to configure network devices and understand their roles in a network.</li>
                        <li>🔵Gain insight into network security protocols, including VPNs and encryption techniques.
                        </li>
                        <li>🔵Be able to design and troubleshoot both wired and wireless networks.</li>
                    </ul>
            ...
            <div class="section-container-sec4">
                ...
                <div class="right-part-sec4">
                    ...
                    <div class="faq-item">
                        ...
                        <p>You don’t need advanced knowledge, but basic familiarity with computers will be helpful.
                        </p>
                    </div>

                    <div class="faq-item">
                        <h4>Will I get hands-on experience with network devices?</h4>
                        <p>Yes, there will be practical labs where you’ll work with routers, switches, and virtual network setups.</p>
                    </div>

                    <div class="faq-item">
                        <h4>How will this course help me in my career?</h4>
                        <p>You'll gain the skills necessary to design and manage secure networks, a critical requirement in IT roles.
                        </p>
                    </div>
                </div>
            </div>
